...
local Utility = {}
local Objects = {}
function Cloud:DraggingEnabled(frame, parent)
...
local themes = {
    SchemeColor = Color3.fromRGB(24, 24, 24),
...
function Cloud.CreateLib(kavName, themeList)
    ...
    Cloud:DraggingEnabled(MainHeader, Main)
    ...
    function Cloud:ChangeColor(prope,color)
